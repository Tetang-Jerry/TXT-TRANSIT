...
@section('content')
    <main>
        ...
        <div class="flex flex-col  place-items-center">
            ...
            <form action="{{route('userLogin')}}" method="post" class="mt-6 py-10 px-12 w-2/6 h-auto shadow-xl shadow-gray-400 rounded-xl bg-white mx-auto">
                @csrf
                ...
                <div class="mt-5 flex flex-col gap-8">
                    ...
                    @if(Session::has('tokenerror'))
                        <p class="text-red-500 py-3 text-center">{{Session::get('tokenerror')}}</p>
                        <a href="{{route('codeView')}}" class="px-5 py-3 flex mx-auto w-fit justify-center border-primary border rounded-md">Verify your code</a>
                    @endif
                    <div class="mt-5">
